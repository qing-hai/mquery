...
'gt gte lt lte ne in nin all regex size maxDistance minDistance not type text bitsAllSet bitsAnySet bitsAllClear bitsAnyClear'.split(' ').forEach(function ($conditional) {
